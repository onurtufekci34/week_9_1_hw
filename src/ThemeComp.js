  ...
  return (
    <div className="theme">
      <div className={`App ${theme}`}>
        ...
        <label htmlFor="darkmode-toggle" onClick={handleThemeChange}>
        ...
        <p>
          ...
          similique blanditiis aliquam quas nihil delectus, numquam eaque vitae
          ad ducimus ullam mollitia minima ea hic inventore deleniti unde
